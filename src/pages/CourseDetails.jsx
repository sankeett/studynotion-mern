...
function CourseDetails() {
  console.log("ROUTE HIT 👉 CourseDetails rendered")
  ...
  // Local state (ALL hooks first – eslint safe)
  ...
  useEffect(() => {
    ;(async () => {
      try {
        ...
        console.log("📦 fetchCourseDetails response:", res)
        ...
        // FIX: Extract the course object from the array if it's an array
